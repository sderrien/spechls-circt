fsm.machine @SpecSCC_361_fsm(%mispec_l_pc: i8,%mispec_l_pc0: i8) -> (i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1) 
...
fsm.state @l_pc1__Fill2 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t26,%default_commit_l_pc,%t29,%t27,%default_rollback_l_pc,%default_startStall_l_pc,%t28,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	fsm.transition @l_pc1__Fill3 guard  {
		%t30 = hw.constant 1 : i1
	  fsm.return %t30
	} 
}
fsm.state @l_pc1__Fill3 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t31,%t34,%t37,%t35,%default_rollback_l_pc,%default_startStall_l_pc,%t36,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	...
	fsm.transition @l_pc1_l_pc00__Rollback guard  {
		...
		%t40 = comb.icmp eq %mispec_l_pc0,%t39 : i8
	  fsm.return %t40
	} 
}
...
fsm.state @l_pc00__Fill1 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t51,%t54,%default_commit_l_pc0,%t53,%default_rollback_l_pc,%default_startStall_l_pc,%t52,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
...
fsm.state @l_pc00__Fill2 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t56,%t59,%default_commit_l_pc0,%t58,%default_rollback_l_pc,%default_startStall_l_pc,%t57,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	fsm.transition @l_pc00__Fill3 guard  {
		%t60 = hw.constant 1 : i1
	  fsm.return %t60
	} 
}
fsm.state @l_pc00__Fill3 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t61,%t67,%t64,%t65,%default_rollback_l_pc,%default_startStall_l_pc,%t66,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	fsm.transition @Proceed guard  {
	...
	fsm.transition @l_pc1__Rollback guard  {
		...
		%t70 = comb.icmp eq %mispec_l_pc,%t69 : i8
	  fsm.return %t70
	} 
}
...
fsm.state @l_pc1_l_pc00__Fill0 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t76,%t79,%default_commit_l_pc0,%t78,%default_rollback_l_pc,%default_startStall_l_pc,%t77,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
...
fsm.state @l_pc1_l_pc00__Fill1 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t81,%t84,%default_commit_l_pc0,%t83,%default_rollback_l_pc,%default_startStall_l_pc,%t82,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
...
fsm.state @l_pc1_l_pc00__Fill2 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t86,%t89,%default_commit_l_pc0,%t88,%default_rollback_l_pc,%default_startStall_l_pc,%t87,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	fsm.transition @l_pc1_l_pc00__Fill3 guard  {
		%t90 = hw.constant 1 : i1
	  fsm.return %t90
	} 
}
fsm.state @l_pc1_l_pc00__Fill3 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t91,%t98,%t95,%t96,%default_rollback_l_pc,%default_startStall_l_pc,%t97,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	fsm.transition @Proceed guard  {
...
fsm.state @Init0 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t100,%default_commit_l_pc,%default_commit_l_pc0,%t101,%default_rollback_l_pc,%default_startStall_l_pc,%t102,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
...
fsm.state @Init1 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t104,%default_commit_l_pc,%default_commit_l_pc0,%t105,%default_rollback_l_pc,%default_startStall_l_pc,%t106,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
...
fsm.state @Init2 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t108,%default_commit_l_pc,%default_commit_l_pc0,%t109,%default_rollback_l_pc,%default_startStall_l_pc,%t110,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
...
fsm.state @Init3 output  {
	...
	%default_startStall_l_pc0 = hw.constant 0 : i1
   	fsm.output %default_array_rollback,%default_mu_rollback,%default_rewind,%t112,%default_commit_l_pc,%default_commit_l_pc0,%t113,%default_rollback_l_pc,%default_startStall_l_pc,%t114,%default_rollback_l_pc0,%default_startStall_l_pc0:i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1
} transitions  {
	fsm.transition @Proceed guard  {
