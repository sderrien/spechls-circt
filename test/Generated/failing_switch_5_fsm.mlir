fsm.machine @SpecSCC_103_fsm(%mispec_y: i8,%mispec_x: i8) -> (i8,i8,i8,i1,i1,i1,i8,i8,i1,i8,i8,i1) 
...
fsm.state @y1__Fill2 output  {
	...
	fsm.transition @y1_x1__Rollback guard  {
...
fsm.state @y1_x1__Rollback output  {
	...
	fsm.transition @y1_x1__Fill0 guard  {
		%t129 = hw.constant 1 : i1
	  fsm.return %t129
	} 
}
fsm.state @y1_x1__Fill0 output  {

	 %t130 = hw.constant 1 : i1 
	
	 %t131 = hw.constant 0 : i8 
	...
	fsm.transition @y1_x1__Fill1 guard  {
		%t134 = hw.constant 1 : i1
	  fsm.return %t134
	} 
}
fsm.state @y1_x1__Fill1 output  {
	...
	fsm.transition @y1_x1__Fill2 guard  {
		%t139 = hw.constant 1 : i1
	  fsm.return %t139
	} 
}
fsm.state @y1_x1__Fill2 output  {
